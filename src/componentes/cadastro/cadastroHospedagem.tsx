...
function CadastroHospedagem() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      const hospedagensExistentes = JSON.parse(localStorage.getItem('hospedagens') || '[]')
      hospedagensExistentes.push(hospedagem)
      localStorage.setItem('hospedagens', JSON.stringify(hospedagensExistentes))

      console.log('Hospedagem cadastrada:', hospedagem)
      ...
      alert('Erro ao cadastrar hospedagem!')
    }
  }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <select
              ...
              onChange={(e) => setHospedagem({ ...hospedagem, idCliente: Number(e.target.value) })}
              required
